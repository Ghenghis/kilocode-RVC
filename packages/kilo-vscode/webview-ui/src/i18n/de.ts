...
export const dict = {
  ...
  // Speech & Voice Studio keys (English fallback)
  "settings.speech.title": "Speech",
  "settings.speech.enabled.title": "Enable Speech",
  "settings.speech.enabled.description": "Enable text-to-speech output for assistant replies.",
  "settings.speech.autoSpeak.title": "Auto-Speak",
  "settings.speech.autoSpeak.description": "Automatically speak assistant replies when they complete.",
  "settings.speech.provider.title": "Provider",
  "settings.speech.provider.description": "Select the TTS provider to use.",
  "settings.speech.provider.browser": "Browser (Web Speech API)",
  "settings.speech.provider.azure": "Azure Neural TTS",
  "settings.speech.provider.rvc": "RVC (Docker)",
  "settings.speech.volume.title": "Volume",
  "settings.speech.volume.description": "Speech output volume level.",
  "settings.speech.rvc.title": "RVC Settings",
  "settings.speech.rvc.port.title": "Docker Port",
  "settings.speech.rvc.port.description": "Port for the RVC Docker container.",
  "settings.speech.rvc.voice.title": "Voice Model",
  "settings.speech.rvc.voice.description": "RVC voice model folder name.",
  "settings.speech.rvc.online": "Online",
  "settings.speech.rvc.offline": "Offline",
  "settings.speech.rvc.refresh": "Check Connection",
  "settings.speech.rvc.checking": "Checking...",
  "settings.speech.rvc.setup.title": "RVC Docker Setup",
  "settings.speech.rvc.setup.step1": "1. Pull and start the RVC Docker container:",
  "settings.speech.rvc.setup.step2": "2. Add voice models (copy RVC .pth model folders into the container):",
  "settings.speech.rvc.setup.note": "Voice models are RVC-trained .pth files in named folders. After adding models, click \"Check Connection\" to detect them.",
  "settings.speech.rvc.setup.autoDesc": "Click Auto Setup to automatically detect Docker, pull the image, find a free port, start the container, and load your voices.",
  "settings.speech.rvc.setup.autoButton": "Auto Setup",
  "settings.speech.rvc.setup.running": "Setting up2026",
  "settings.speech.rvc.setup.rerun": "Re-run Setup",
  "settings.speech.rvc.setup.working": "Working2026",
  "settings.speech.rvc.voice.placeholder": "Start Docker to see voices",
  "settings.speech.rvc.voice.startDocker": "Start the Docker container to browse available voice models.",
  "settings.speech.rvc.edgeVoice.title": "Baseline Voice",
  "settings.speech.rvc.edgeVoice.description": "Azure Neural voice used as the TTS baseline before RVC conversion.",
  "settings.speech.rvc.pitchShift.title": "Pitch Shift",
  "settings.speech.rvc.pitchShift.description": "Shift pitch in semitones (-12 to +12) during voice conversion.",
  "settings.speech.azure.title": "Azure Settings",
  "settings.speech.azure.apiKey.title": "API Key",
  "settings.speech.azure.apiKey.description": "Azure Cognitive Services subscription key.",
  "settings.speech.azure.region.title": "Region",
  "settings.speech.azure.region.description": "Azure service region (e.g. eastus, westus2).",
  "settings.speech.azure.locale.title": "Locale Filter",
  "settings.speech.azure.locale.description": "Filter voices by English locale.",
  "settings.speech.azure.voice.title": "Voice",
  "settings.speech.azure.voice.description": "Azure Neural TTS voice to use.",
  "settings.speech.browser.title": "Browser Settings",
  "settings.speech.browser.voice.title": "Voice",
  "settings.speech.browser.voice.description": "Browser speech synthesis voice.",
  "settings.speech.browser.rate.title": "Rate",
  "settings.speech.browser.rate.description": "Speech rate (0.5 to 2.0).",
  "settings.speech.browser.pitch.title": "Pitch",
  "settings.speech.browser.pitch.description": "Speech pitch (0.5 to 2.0).",
  "settings.speech.preview.title": "Preview",
  "settings.speech.preview.placeholder": "Type text to preview speech output...",
  "settings.speech.preview.play": "Play Preview",
  "settings.speech.preview.stop": "Stop",
  "settings.speech.preview.defaultText": "Hello! This is a preview of the speech output.",
  "settings.speech.azure.apiKey.placeholder": "Enter Azure API key",
  "settings.speech.azure.locale.all": "All Locales",
  "settings.speech.rvc.modelBrowser.title": "RVC Model Browser",
  "settings.speech.rvc.modelBrowser.serverUrl.title": "Model Server URL",
  "settings.speech.rvc.modelBrowser.serverUrl.description": "URL of the remote model server hosting downloadable RVC voice models.",
  "settings.speech.rvc.modelBrowser.serverUrl.placeholder": "https://voice.daveai.tech",
  "settings.speech.rvc.modelBrowser.available.title": "Available Models",
  "settings.speech.rvc.modelBrowser.available.description": "RVC voice models available for download from the model server.",
  "settings.speech.rvc.modelBrowser.refresh": "Refresh",
  "settings.speech.rvc.modelBrowser.refreshing": "Refreshing...",
  "settings.speech.rvc.modelBrowser.download": "Download",
  "settings.speech.rvc.modelBrowser.downloading": "Downloading...",
  "settings.speech.rvc.modelBrowser.installed": "Installed",
  "settings.speech.rvc.modelBrowser.available": "Available",
  "settings.speech.rvc.modelBrowser.noModels": "No models found on the server.",
  "settings.speech.rvc.modelBrowser.fetchError": "Failed to fetch models from server.",
  "settings.speech.rvc.modelBrowser.localModels.title": "Local Models",
  "settings.speech.rvc.modelBrowser.localModels.description": "RVC voice models installed in the local Docker container.",
  "settings.speech.rvc.modelBrowser.localModels.none": "No local models found. Download models above or copy them into the Docker container.",
  "settings.speech.rvc.modelBrowser.fileSize": "Size",
  "settings.speech.voiceStudio.title": "Voice Studio",
  "settings.speech.voiceStudio.tabs.library": "Library",
  "settings.speech.voiceStudio.tabs.store": "Store",
  "settings.speech.voiceStudio.library.subtabs.all": "All",
  "settings.speech.voiceStudio.library.subtabs.favorites": "Favorites",
  "settings.speech.voiceStudio.library.subtabs.recent": "Recent",
  "settings.speech.voiceStudio.search.placeholder": "Search voices...",
  "settings.speech.voiceStudio.search.voicePlaceholder": "Speak to search...",
  "settings.speech.voiceStudio.search.noResults": "No voices match your search",
  "settings.speech.voiceStudio.search.clear": "Clear search",
  "settings.speech.voiceStudio.search.save": "Save search",
  "settings.speech.voiceStudio.search.saved": "Saved Searches",
  "settings.speech.voiceStudio.search.recentSearches": "Recent",
  "settings.speech.voiceStudio.search.accentSuggestion": "Add filter",
  "settings.speech.voiceStudio.search.voiceMatches": "Voices",
  "settings.speech.voiceStudio.filters.gender": "Gender",
  "settings.speech.voiceStudio.filters.all": "All",
  "settings.speech.voiceStudio.filters.male": "Male",
  "settings.speech.voiceStudio.filters.female": "Female",
  "settings.speech.voiceStudio.filters.neutral": "Neutral",
  "settings.speech.voiceStudio.filters.accent": "Accent",
  "settings.speech.voiceStudio.filters.style": "Style",
  "settings.speech.voiceStudio.filters.provider": "Provider",
  "settings.speech.voiceStudio.filters.mood": "Mood",
  "settings.speech.voiceStudio.filters.clearAll": "Clear all filters",
  "settings.speech.voiceStudio.filters.installedOnly": "Installed",
  "settings.speech.voiceStudio.moods.warm": "Warm",
  "settings.speech.voiceStudio.moods.calm": "Calm",
  "settings.speech.voiceStudio.moods.bright": "Bright",
  "settings.speech.voiceStudio.moods.deep": "Deep",
  "settings.speech.voiceStudio.moods.robotic": "Robotic",
  "settings.speech.voiceStudio.moods.professional": "Professional",
  "settings.speech.voiceStudio.voice.preview": "Preview",
  "settings.speech.voiceStudio.voice.setActive": "Set Active",
  "settings.speech.voiceStudio.voice.download": "Download",
  "settings.speech.voiceStudio.voice.downloading": "Downloading...",
  "settings.speech.voiceStudio.voice.installed": "Installed",
  "settings.speech.voiceStudio.voice.favorite": "Favorite",
  "settings.speech.voiceStudio.voice.unfavorite": "Remove favorite",
  "settings.speech.voiceStudio.voice.delete": "Delete",
  "settings.speech.voiceStudio.voice.quality": "Quality",
  "settings.speech.voiceStudio.voice.customPreview": "Custom preview",
  "settings.speech.voiceStudio.voice.heroPreview": "Quick preview",
  "settings.speech.voiceStudio.voice.typePreviewText": "Type preview text...",
  "settings.speech.voiceStudio.store.showing": "Showing",
  "settings.speech.voiceStudio.store.of": "of",
  "settings.speech.voiceStudio.store.voices": "voices",
  "settings.speech.voiceStudio.store.page": "Page",
  "settings.speech.voiceStudio.store.previous": "Previous",
  "settings.speech.voiceStudio.store.next": "Next",
  "settings.speech.voiceStudio.store.loading": "Loading voice catalog...",
  "settings.speech.voiceStudio.store.error": "Failed to load catalog",
  ...
  "settings.speech.voiceStudio.downloads.downloading": "Downloading",
  "settings.speech.voiceStudio.downloads.extracting": "Extracting",
  "settings.speech.voiceStudio.downloads.installing": "Installing",
  "settings.speech.voiceStudio.downloads.done": "Complete",
  "settings.speech.voiceStudio.downloads.failed": "Failed",
  "settings.speech.voiceStudio.downloads.cancel": "Cancel",
  "settings.speech.voiceStudio.downloads.retry": "Retry",
  "settings.speech.voiceStudio.library.showing": "Showing",
  "settings.speech.voiceStudio.library.nowPlaying": "Active Voice",
  "settings.speech.voiceStudio.library.noFavorites": "No favorites yet — star voices to add them here",
  "settings.speech.voiceStudio.library.noRecent": "No recent voices — voices you use will appear here",
  "settings.speech.voiceStudio.library.noVoices": "No voices installed",
  "settings.speech.voiceStudio.library.visitStore": "Visit the Store tab to download voices",
  "settings.speech.voiceStudio.interaction.silent": "Silent",
  "settings.speech.voiceStudio.interaction.assist": "Assist",
  "settings.speech.voiceStudio.interaction.handsfree": "Hands-Free",
  "settings.speech.voiceStudio.interaction.silentDesc": "No speech output",
  "settings.speech.voiceStudio.interaction.assistDesc": "Auto-speak responses",
  "settings.speech.voiceStudio.interaction.handsfreeDesc": "Full bidirectional voice control",
  "settings.speech.voiceStudio.commands.switchTo": "Switching to",
  "settings.speech.voiceStudio.commands.repeat": "Repeating last response",
  "settings.speech.voiceStudio.commands.stop": "Stopping speech",
  "settings.speech.voiceStudio.commands.slower": "Slowing down",
  "settings.speech.voiceStudio.commands.faster": "Speeding up",
  "settings.speech.voiceStudio.commands.louder": "Increasing volume",
  "settings.speech.voiceStudio.commands.softer": "Decreasing volume",
  "settings.speech.voiceStudio.commands.handsFreeOff": "Switching to assist mode",
  "settings.speech.voiceStudio.commands.listening": "Listening for commands...",
  "settings.speech.voiceStudio.commands.notRecognized": "Command not recognized",
