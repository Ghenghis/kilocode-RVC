  ...
  return (
    <div style={{ display: "flex", "flex-direction": "column", gap: "16px" }}>
      ...
      <Card>
        ...
        <SettingsRow
          title={language.t("settings.speech.interactionMode.title")}
          description={language.t("settings.speech.interactionMode.description")}
        >
          <Select
            options={[
            ...
            label={(o) => o.label}
            onSelect={(o) => {
              if (o) updateField("interactionMode", o.value as "silent" | "assist" | "handsfree")
            }}
            variant="secondary"
            size="small"
