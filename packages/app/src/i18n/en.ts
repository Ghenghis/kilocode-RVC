export const dict = {
  ...
  "settings.speech.row.azureLocale.title": "Locale Filter",
  "settings.speech.row.azureLocale.description": "Filter voices by English locale",
  ...
  "settings.speech.preview.failed": "Preview failed",
}
